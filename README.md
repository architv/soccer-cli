...
For building from source, you'll need to get your API key from [here](http://api.football-data.org/register) and replace `'X-Auth-Token': authtoken.API_TOKEN` with `'X-Auth-Token': <YOUR_API_KEY>`.
